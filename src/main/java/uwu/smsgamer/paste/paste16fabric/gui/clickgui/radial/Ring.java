...
|                                                      |
\*----------------------------------------------------*/
package uwu.smsgamer.paste.paste16fabric.gui.clickgui.radial;

import uwu.smsgamer.paste.paste16fabric.input.MouseHelper;

import java.awt.*;

import static uwu.smsgamer.paste.paste16fabric.utils.RenderUtils.drawCircle;
...
public abstract class Ring {
    ...
    public final void render() {
        ...
        dist = Math.sqrt((mc.mouse.getX() - 250) * (mc.mouse.getX() - 250) +
          (mc.mouse.getY() - 250) * (mc.mouse.getY() - 250)) * 1.2;
        if (dist > 187.5) {
        ...
        rot = Math.atan2(mc.mouse.getY() - 250, 250 - mc.mouse.getX()) * 180 / Math.PI + 180;
        renderStuff();
